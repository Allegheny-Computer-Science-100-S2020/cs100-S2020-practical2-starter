# cs100-S2020-practical2-starter
...
the previous command will work correctly, for a single time only you should
create the cache directory by running the command `mkdir $HOME/.dockagator` on
the MacOS and Linux operating systems. However, if you are using the Windows
operating system then you will instead need to type the command `mkdir
%HomeDrive%%HomePath%/.dockagator`. Finally, if the above `docker run` command
does not work correctly on the Windows operating system, you may need to
instead run the following command to adapt to the differences in the `cmd`
terminal window:
...
diagnostic information and produce output like the following. Please don't
forget that when you run your program it must produce output containing the
symbols `@@`!
...
- The DisplayArtwork.java in src/main/java/practicaltwo has exactly 1 of the `@@` fragment
...
- The DisplayArtwork.java in src/main/java/practicaltwo has exactly 1 of the `public static void main` fragment
...
```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 15/15 (100%) of checks for cs100-S2020-practical2! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-S2020/cs100-S2020-practical2-starter/
```
...
2](https://github.com/Allegheny-Computer-Science-100-S2020/cs100-S2020-practical2-starter)
repository and [raise an
issue](https://github.com/Allegheny-Computer-Science-100-S2020/cs100-S2020-practical2-starter/issues).
...
message by the morning of the project's due date. After the instructor responds
to the issue, please resolve all of the stated concerns and participate in the
discussion until the issue is closed.
